...
@implementation AddViewController3
...
- (void) save_Clicked:(id)sender {
	...
	coffeeObj3.LeadDate = today2Date;



	NSString *temp3 = [[NSString alloc] initWithString:txtPersonID.text];
	coffeeObj3.personID = temp3; 
	
	if (txtCoffeeName.text.length != 0) {
		
	
	coffeeObj3.isDirty = NO;
	coffeeObj3.isDetailViewHydrated = YES;

	
	//Add the object
	[appDelegate addInvoices:coffeeObj3];
		
	//Flurry - Someone added an Invoice
	[FlurryAPI logEvent:@"Added an Invoice"];
